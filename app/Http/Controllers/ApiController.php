...
class ApiController extends Controller
{
    ...
    {
        $transformedData = fractal()->collection($collection)->transformWith($callback)->toArray();
        return $this->respondWithArray($transformedData);
    }

    protected function respondWithPaginatedCollection($paginator, $callback)
    {
        $transformedData = fractal()->collection($paginator->getCollection())->transformWith($callback)
