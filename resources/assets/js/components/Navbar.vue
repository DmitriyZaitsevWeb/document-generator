    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarToggler">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <router-link :to="{ name: 'forms' }" tag="li" class="nav-item">
            <a class="nav-link">
              Forms
            </a>
          </router-link>
          <router-link :to="{ name: 'categories' }" tag="li" class="nav-item">
            <a class="nav-link">
              Categories
            </a>
          </router-link>
        ...
        <ul class="navbar-nav">
          ...
          <template v-if="authenticated">
            <router-link :to="{ name: 'admin-panel.dashboard' }" tag="li" class="nav-item" v-if="user.role === 'admin'">
              <a class="nav-link">
                Admin Panel
              </a>
            </router-link>
